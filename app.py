...
<style>
    ...
    /* COMPACTACIÓN DE TARJETAS DE ÓRDENES Y SECCIÓN INFERIOR */
    .order-card {
...
def render_tablero_fluido():
    ...
    if df_vista is not None and not df_vista.empty:
        ...
        # APLICAR FILTRADO POR BÚSQUEDA SI EXISTE TEXTO
